 ...
 * ${jp(0x5b9f, 0x884c, 0x6642, 0x306f, 0x20, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x73, 0x2f, 0x73, 0x63, 0x61, 0x6e, 0x2d, 0x65, 0x78, 0x70, 0x65, 0x6e, 0x73, 0x65, 0x2d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x2e, 0x6d, 0x6a, 0x73, 0x3067, 0x81ea, 0x52d5, 0x66f4, 0x65b0, 0x3057, 0x307e, 0x3059, 0x3002)}
 */
...
/** ${jp(0x4ed5, 0x8a33, 0x30c7, 0x30fc, 0x30bf, 0x3068, 0x4e00, 0x89a7, 0x3092, 0x30de, 0x30fc, 0x30b8, 0xFF08, 0x4e00, 0x89a7, 0x306b, 0x306a, 0x3044, 0x79d1, 0x76ee, 0x306f, 0x672b, 0x5c3e, 0x3001, 0x4ed5, 0x8a33, 0x884c, 0x306f, 0x51fa, 0x529b, 0x3055, 0x306a, 0x3044, 0xFF09)} */
 ...
 * ${jp(0x5168, 0x671f, 0x306e, 0x4ed5, 0x8a33, 0x20, 0x43, 0x53, 0x56, 0x304b, 0x3089, 0x8af8, 0x7d4c, 0x8cbb, 0x52d8, 0x5b9a, 0x79d1, 0x76ee, 0x3092, 0x6383, 0x63cf, 0x3057, 0x3001, 0x65, 0x78, 0x70, 0x65, 0x6e, 0x73, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x6a, 0x73, 0x3092, 0x66f4, 0x65b0, 0x3059, 0x308b, 0x3002)}
...
function updateExpenseAccountConfig(accounts) {
  ...
  if (updated === source) {
    throw new Error(${escapeSingleQuoted(jp(0x45, 0x58, 0x50, 0x45, 0x4e, 0x53, 0x45, 0x5f, 0x53, 0x45, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x41, 0x43, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x53, 0x306e, 0x66, 0x4f, 0x66, 0x306b, 0x5931, 0x6557, 0x3057, 0x307e, 0x3057, 0x305f))});
  }
...
if (unchanged) {
  ...
  console.log(\`${jp(0x66, 0x4F, 0x66, 0x3057, 0x307e, 0x3057, 0x305f, 0x3a, 0x20)}\${configPath}\`);
...
if (EXPENSE_CONFIG) {
  ...
  for (const required of REQUIRED_EXPENSE_ACCOUNTS) {
    if (!expenseText.includes(required)) {
      errors.push(\`src/config/expenseAccountConfig.js: \${jp(0x6b63, 0x3057, 0x3044, 0x8868, 0x8a18, 0x304c, 0x3042, 0x308a, 0x307e, 0x305b, 0x3093, 0xFF08)}\${required}${jp(0xFF09)}\`);
    }
  }
}
